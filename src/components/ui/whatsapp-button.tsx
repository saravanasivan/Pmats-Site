...
const WhatsAppButton = () => {
  const phoneNumber = "+917012351774" // Add your WhatsApp number here
  const whatsappUrl = `https://wa.me/${phoneNumber}`

  return (
    <Button
      className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#128C7E] shadow-lg hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center p-0"
